...
#let dtedges =  (
 (vertices:(<OW>,<OE>),bend:88deg,..electron,label:[$a_1$],label-sep:0mm,label-side:right),
 (vertices:(<OE>,<OW>),bend:88deg,..electron,label:[$a_2$],label-sep:0mm,label-side:right),
